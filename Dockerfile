...
# Build
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH} go build KittDoesntCode/pmoxs3backuproxy/cmd/pmoxs3backuproxy
RUN CGO_ENABLED=0 GOOS=${TARGETOS:-linux} GOARCH=${TARGETARCH} go build KittDoesntCode/pmoxs3backuproxy/cmd/garbagecollector
